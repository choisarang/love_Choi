(function($){
  ...
  // 해당페이지 선택효과 =====================================
  gnbLi.eq(2).find('dt').children('a').addClass('select');
  gnbLi.eq(2).find('dd').children('a').eq(1).addClass('select');
  gnbLi.eq(2).find('dd').css({backgroundColor:"rgba(140, 177, 200, 0.1)"})
